<template>
  <div class="scroll-section h-full text-center pt-[5rem]" id="home">
    ...
    <div class="mt-8 space-y-6">
      ...
      <div class="flex flex-col items-center">
        <label id="custom-url-label" class="text-gray-700 text-sm font-semibold mb-1">사용자 정의 URL 등록</label>
        <div class="flex items-center w-3/4">
          <input id="custom-url" v-model="profile.customUrl" type="text" placeholder="예: my-unique-url"
            class="border border-gray-300 rounded-lg flex-grow h-full" @input="handleInput" />
        </div>
      </div>
      ...
      <div class="flex items-center justify-between w-3/4 mx-auto">
        ...
        <div class="relative inline-block w-12 align-middle select-none transition duration-200 ease-in">
          <input type="checkbox" v-model="profile.isAdmissionResult"
      ...
      <div class="flex items-center justify-between w-3/4 mx-auto">
        ...
        <div class="relative inline-block w-12 align-middle select-none transition duration-200 ease-in">
          <input type="checkbox" v-model="profile.isEarlyDecision" class="toggle-checkbox absolute opacity-0 w-0 h-0" />
          <label
            class="toggle-label block w-12 h-6 rounded-full bg-gray-300 cursor-pointer transition-colors duration-200 ease-in-out">
            <span
              class="toggle-circle absolute left-0 top-0 bg-white w-6 h-6 rounded-full shadow-md transform transition-transform duration-200 ease-in-out"></span>
      ...
      <div class="flex items-center justify-between w-3/4 mx-auto">
        ...
        <div class="relative inline-block w-12 align-middle select-none transition duration-200 ease-in">
          <input type="checkbox" v-model="profile.isRegularDecision"
            class="toggle-checkbox absolute opacity-0 w-0 h-0" />
          <label
            class="toggle-label block w-12 h-6 rounded-full bg-gray-300 cursor-pointer transition-colors duration-200 ease-in-out">
            <span
